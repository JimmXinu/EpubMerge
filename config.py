...
Only Epubs merged with 'Keep UnMerge Metadata' can be UnMerged.''')
        ...
        horz = QHBoxLayout()
        horz.addWidget(QLabel("Merged Book Word:"))
        
        self.mergeword = QLineEdit(self)
        self.mergeword.setText(prefs['mergeword'])
        self.mergeword.setToolTip('''Word use to describe merged books in default title and summary.
