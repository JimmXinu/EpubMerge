...
class ColumnSumBase(InterfaceActionBase):
    '''
    ...
    ColumnSumPlugin and is defined in the columnsum_plugin.py file, as
    ...
    actual_plugin       = 'calibre_plugins.columnsum.columnsum_plugin:ColumnSumPlugin'
    ...
    def config_widget(self):
        ...
        from calibre_plugins.columnsum.config import ConfigWidget
